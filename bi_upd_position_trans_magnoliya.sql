-- drop table dwh.bi_upd_position_trans_magnoliya;
-- truncate table dwh.bi_upd_position_trans_magnoliya;

create table dwh.bi_upd_position_trans_magnoliya
(
inttypeid bigint,
intchainid bigint,
intdocid bigint,
...
create index bi_upd_position_trans_magnoliya_idx1 on bi_upd_position_trans_magnoliya (intdocid);

analyze verbose dwh.bi_upd_position_trans_magnoliya;